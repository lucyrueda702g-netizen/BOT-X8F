...
const vipCommands = [
    ...
    new SlashCommandBuilder()
        ...
        .setDescription('📨 Solicitar membresía VIP')
        .addStringOption(o => o.setName('invite').setDescription('Link discord.gg/...').setRequired(true))
        .addStringOption(o => o.setName('descripcion').setDescription('Descripción de tu servidor').setRequired(true))
        .addStringOption(o => o.setName('tag').setDescription('Gaming, Anime, Roblox, etc.').setRequired(true)),

    new SlashCommandBuilder()
        .setName('vip-aprobar')
        .setDescription('✅ Aprobar solicitud VIP')
    ...
    new SlashCommandBuilder()
        .setName('vip-revocar')
        .setDescription('🚫 Revocar VIP')
        .addUserOption(o => o.setName('usuario').setDescription('Usuario').setRequired(true))
        .setDefaultMemberPermissions(PermissionFlagsBits.Administrator),

    new SlashCommandBuilder()
        .setName('vip-lista')
        .setDescription('📋 Ver miembros VIP activos'),

    new SlashCommandBuilder()
        .setName('vip-solicitudes')
        .setDescription('📬 Solicitudes VIP pendientes')
        .setDefaultMemberPermissions(PermissionFlagsBits.Administrator),

    new SlashCommandBuilder()
        .setName('vip-publicar')
        .setDescription('📢 Publicar tu servidor en canales VIP')
        .addStringOption(o => o.setName('mensaje').setDescription('Mensaje extra (opcional)')),

    new SlashCommandBuilder()
        .setName('vip-canal')
        .setDescription('📌 Canal donde se muestran los VIPs')
        .addChannelOption(o => o.setName('canal').setDescription('Canal').setRequired(true))
        .setDefaultMemberPermissions(PermissionFlagsBits.Administrator),

    new SlashCommandBuilder()
        .setName('vip-ads-canal')
        .setDescription('📢 Canal para recibir anuncios VIP')
        .addChannelOption(o => o.setName('canal').setDescription('Canal').setRequired(true))
        .setDefaultMemberPermissions(PermissionFlagsBits.Administrator),
    ...
    new SlashCommandBuilder()
        ...
        .addStringOption(o => o.setName('invite').setDescription('Nuevo invite'))
        .addStringOption(o => o.setName('tag').setDescription('Nuevo tag')),

    new SlashCommandBuilder()
        .setName('vip-boost')
        .setDescription('🚀 Destacar tu anuncio VIP por 24h'),
